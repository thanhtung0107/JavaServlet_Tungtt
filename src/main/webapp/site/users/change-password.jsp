		...
		<div class="card">
			...
			<jsp:include page="/common/inform.jsp"></jsp:include>
				<div class="row">
					<div class="col">
						<div class="form-group">
							<label for="username">Username</label> <input type="text"
								...
								id="usernameHid" class="form-text text-muted">Help text</small>
						</div>
						<div class="form-group">
					...
					<div class="col">
						<div class="form-group">
							<label for="cureentPassword">Current Password</label> <input
								type="password" class="form-control" name="currentPassword"
								id="cureentPassword" placeholder="Current Password">
						</div>
						<div class="form-group">
